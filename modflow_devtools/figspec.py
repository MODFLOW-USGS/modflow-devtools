...
class USGSFigure:
    def __init__(
        self, figure_type="map", family="Arial Narrow", verbose=False
    ):
    ...
    def heading(
        ...
        if letter is not None:
            ...
            bbox = ax.get_window_extent().transformed(
                mpl.pyplot.gcf().dpi_scale_trans.inverted()
            )
    ...
    def _set_fontspec(
        ...
        """
        univers = "Univers" in self.family
        family = None if univers else self.family
